    ...
    public void setMainApp(MainApp mainApp) {
        ...
        while(iterator.hasNext()){
            ...
            projectList.add(new ProjectType(
                    ...
                    hashMap.get("montant").toString(),"","",hashMap.get("id").toString(), hashMap.get("montant").toString()
            ));
        }
    }
            ...
            public void handle(ActionEvent event) {
                if(main_libelle.getText().isEmpty() || main_taux.getText().isEmpty()){
                    ...
                    if (id.getText().isEmpty()){
                        ...
                        int selected = tableView.selectionModelProperty().getValue().getSelectedIndex();
                        tableView.getItems().remove(selected);
                        currentsaveId = id.getText();
                    }

                    projectList.add(new ProjectType(
                            main_libelle.getText(),  main_libelle.getText().toString(),
            ...
            p.setOnMouseClicked(event -> {
                if (event.getClickCount() == 2 && !p.isEmpty()){
                    ...
                    try {
                        ...
                        main_taux.setText(projectType.getActivite());
