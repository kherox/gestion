...
/**
 * Created by Univetech Sarl on 20/02/2017.
 */
                ...
                public void handle(ActionEvent event) {
                    ...
                    if(type_libelle.getText().isEmpty() || type_abreviation.getText().isEmpty()){
                        ...
                        if (id.getText().isEmpty()){
                            ...
                            mainApp.manager.SaveData(mainApp.mapObject,"clients_type");
                            currentsaveId = mainApp.manager.getCurrentsaveId();
                        }else{
                            mainApp.manager.UpdateData(mainApp.mapObject,"clients_type",id.getText());
            ...
            delete.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    if (alerts.getResult().getButtonData().isDefaultButton()){
                        mainApp.manager.deleteData("clients_type",selected.getId());
