...
class DevisForm(forms.ModelForm) :
    ...
    finvalidate     = forms.DateField(label="Date de fin de validité  ", widget=forms.DateInput(attrs={'type': 'date'}))
    datedemande     = forms.DateField(label="Date de demande ",  widget=forms.DateInput(attrs={'type': 'date'}))
